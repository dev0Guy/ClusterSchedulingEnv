...
DEFUALT_PARAMS: dict = dict(
    n_machines=5, n_jobs=50, n_resources=3, n_ticks=SIMULATION_LENGTH
)
...
register(id="Cluster-v0", entry_point=create_cluster_v0, kwargs=DEFUALT_PARAMS)
register(
...
register(
    ...
    kwargs={"queue_size": 1, **DEFUALT_PARAMS},
)
register(
